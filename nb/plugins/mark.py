...
from nb.plugin_models import MarkConfig  
...
class TgcfMark(TgcfPlugin):  
    ...
    async def modify_group(self, tms: List[TgcfMessage]) -> List[TgcfMessage]:  
        """Apply watermark to each media message in the group."""  
        for tm in tms:  
